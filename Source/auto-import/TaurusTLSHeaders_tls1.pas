...
var
  ...
  SSL_get_servername_type: function(s: PSSL): TIdC_INT; cdecl = nil;
  {$EXTERNALSYM SSL_get_servername_type}

  SSL_export_keying_material: function(s: PSSL; _out: PIdAnsiChar; olen: TIdC_SIZET; _label: PIdAnsiChar; llen: TIdC_SIZET; context: PIdAnsiChar; contextlen: TIdC_SIZET; use_context: TIdC_INT): TIdC_INT; cdecl = nil;
  {$EXTERNALSYM SSL_export_keying_material}

  SSL_export_keying_material_early: function(s: PSSL; _out: PIdAnsiChar; olen: TIdC_SIZET; _label: PIdAnsiChar; llen: TIdC_SIZET; context: PIdAnsiChar; contextlen: TIdC_SIZET): TIdC_INT; cdecl = nil;
  {$EXTERNALSYM SSL_export_keying_material_early}

  SSL_get_peer_signature_type_nid: function(s: PSSL; pnid: PIdC_INT): TIdC_INT; cdecl = nil;
  {$EXTERNALSYM SSL_get_peer_signature_type_nid}

  SSL_get_signature_type_nid: function(s: PSSL; pnid: PIdC_INT): TIdC_INT; cdecl = nil;
  {$EXTERNALSYM SSL_get_signature_type_nid}

  SSL_get_sigalgs: function(s: PSSL; idx: TIdC_INT; psign: PIdC_INT; phash: PIdC_INT; psignandhash: PIdC_INT; rsig: PIdAnsiChar; rhash: PIdAnsiChar): TIdC_INT; cdecl = nil;
  {$EXTERNALSYM SSL_get_sigalgs}

  SSL_get1_builtin_sigalgs: function(libctx: POSSL_LIB_CTX): PIdAnsiChar; cdecl = nil;
  {$EXTERNALSYM SSL_get1_builtin_sigalgs}

  SSL_get_shared_sigalgs: function(s: PSSL; idx: TIdC_INT; psign: PIdC_INT; phash: PIdC_INT; psignandhash: PIdC_INT; rsig: PIdAnsiChar; rhash: PIdAnsiChar): TIdC_INT; cdecl = nil;
  {$EXTERNALSYM SSL_get_shared_sigalgs}

  SSL_check_chain: function(s: PSSL; x: PX509; pk: PEVP_PKEY; chain: Pstack_st_X509): TIdC_INT; cdecl = nil;
  {$EXTERNALSYM SSL_check_chain}

  SSL_CTX_set_tlsext_ticket_key_evp_cb: function(ctx: PSSL_CTX; fp: TSSL_CTX_set_tlsext_ticket_key_evp_cb_fp_cb): TIdC_INT; cdecl = nil;
...
function SSL_export_keying_material_early(s: PSSL; _out: PIdAnsiChar; olen: TIdC_SIZET; _label: PIdAnsiChar; llen: TIdC_SIZET; context: PIdAnsiChar; contextlen: TIdC_SIZET): TIdC_INT; cdecl;
function SSL_get_peer_signature_type_nid(s: PSSL; pnid: PIdC_INT): TIdC_INT; cdecl;
function SSL_get_signature_type_nid(s: PSSL; pnid: PIdC_INT): TIdC_INT; cdecl;
function SSL_get_sigalgs(s: PSSL; idx: TIdC_INT; psign: PIdC_INT; phash: PIdC_INT; psignandhash: PIdC_INT; rsig: PIdAnsiChar; rhash: PIdAnsiChar): TIdC_INT; cdecl;
function SSL_get1_builtin_sigalgs(libctx: POSSL_LIB_CTX): PIdAnsiChar; cdecl;
function SSL_get_shared_sigalgs(s: PSSL; idx: TIdC_INT; psign: PIdC_INT; phash: PIdC_INT; psignandhash: PIdC_INT; rsig: PIdAnsiChar; rhash: PIdAnsiChar): TIdC_INT; cdecl;
function SSL_check_chain(s: PSSL; x: PX509; pk: PEVP_PKEY; chain: Pstack_st_X509): TIdC_INT; cdecl;
function SSL_CTX_set_tlsext_ticket_key_evp_cb(ctx: PSSL_CTX; fp: TSSL_CTX_set_tlsext_ticket_key_evp_cb_fp_cb): TIdC_INT; cdecl;
{$ENDIF OPENSSL_STATIC_LINK_MODEL}
...
function SSL_export_keying_material_early(s: PSSL; _out: PIdAnsiChar; olen: TIdC_SIZET; _label: PIdAnsiChar; llen: TIdC_SIZET; context: PIdAnsiChar; contextlen: TIdC_SIZET): TIdC_INT; cdecl external CLibCrypto name 'SSL_export_keying_material_early';
function SSL_get_peer_signature_type_nid(s: PSSL; pnid: PIdC_INT): TIdC_INT; cdecl external CLibCrypto name 'SSL_get_peer_signature_type_nid';
function SSL_get_signature_type_nid(s: PSSL; pnid: PIdC_INT): TIdC_INT; cdecl external CLibCrypto name 'SSL_get_signature_type_nid';
function SSL_get_sigalgs(s: PSSL; idx: TIdC_INT; psign: PIdC_INT; phash: PIdC_INT; psignandhash: PIdC_INT; rsig: PIdAnsiChar; rhash: PIdAnsiChar): TIdC_INT; cdecl external CLibCrypto name 'SSL_get_sigalgs';
function SSL_get1_builtin_sigalgs(libctx: POSSL_LIB_CTX): PIdAnsiChar; cdecl external CLibCrypto name 'SSL_get1_builtin_sigalgs';
function SSL_get_shared_sigalgs(s: PSSL; idx: TIdC_INT; psign: PIdC_INT; phash: PIdC_INT; psignandhash: PIdC_INT; rsig: PIdAnsiChar; rhash: PIdAnsiChar): TIdC_INT; cdecl external CLibCrypto name 'SSL_get_shared_sigalgs';
function SSL_check_chain(s: PSSL; x: PX509; pk: PEVP_PKEY; chain: Pstack_st_X509): TIdC_INT; cdecl external CLibCrypto name 'SSL_check_chain';
function SSL_CTX_set_tlsext_ticket_key_evp_cb(ctx: PSSL_CTX; fp: TSSL_CTX_set_tlsext_ticket_key_evp_cb_fp_cb): TIdC_INT; cdecl external CLibCrypto name 'SSL_CTX_set_tlsext_ticket_key_evp_cb';
{$ENDIF}
...
const
  ...
  SSL_CTX_set_tlsext_max_fragment_length_procname = 'SSL_CTX_set_tlsext_max_fragment_length';
  SSL_CTX_set_tlsext_max_fragment_length_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(1);

  SSL_set_tlsext_max_fragment_length_procname = 'SSL_set_tlsext_max_fragment_length';
  SSL_set_tlsext_max_fragment_length_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(1);

  SSL_get_servername_procname = 'SSL_get_servername';
  SSL_get_servername_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(0);

  SSL_get_servername_type_procname = 'SSL_get_servername_type';
  SSL_get_servername_type_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(0);

  SSL_export_keying_material_procname = 'SSL_export_keying_material';
  SSL_export_keying_material_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(0);

  SSL_export_keying_material_early_procname = 'SSL_export_keying_material_early';
  SSL_export_keying_material_early_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(1);

  SSL_get_peer_signature_type_nid_procname = 'SSL_get_peer_signature_type_nid';
  SSL_get_peer_signature_type_nid_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(1);

  SSL_get_signature_type_nid_procname = 'SSL_get_signature_type_nid';
  SSL_get_signature_type_nid_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(1a);

  SSL_get_sigalgs_procname = 'SSL_get_sigalgs';
  SSL_get_sigalgs_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(0);

  SSL_get1_builtin_sigalgs_procname = 'SSL_get1_builtin_sigalgs';
  SSL_get1_builtin_sigalgs_introduced = (byte(3) shl 8 or byte(4)) shl 8 or byte(0);

  SSL_get_shared_sigalgs_procname = 'SSL_get_shared_sigalgs';
  SSL_get_shared_sigalgs_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(0);

  SSL_check_chain_procname = 'SSL_check_chain';
  SSL_check_chain_introduced = (byte(1) shl 8 or byte(1)) shl 8 or byte(0);

  SSL_CTX_set_tlsext_ticket_key_evp_cb_procname = 'SSL_CTX_set_tlsext_ticket_key_evp_cb';
  SSL_CTX_set_tlsext_ticket_key_evp_cb_introduced = (byte(3) shl 8 or byte(0)) shl 8 or byte(0);
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_set_tlsext_status_type(ssl, type) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_get_tlsext_status_ocsp_resp(ssl, arg) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_set_tlsext_status_ocsp_resp(ssl, arg, arglen) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_get0_tlsext_status_ocsp_resp_ex(ssl, arg) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_set0_tlsext_status_ocsp_resp_ex(ssl, arg) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_CTX_get_tlsext_status_cb(ssl, cb) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_CTX_set_tlsext_status_cb(ssl, cb)                     \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_CTX_get_tlsext_status_arg(ssl, arg) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_CTX_set_tlsext_status_arg(ssl, arg) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_CTX_set_tlsext_status_type(ssl, type) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_CTX_get_tlsext_status_type(ssl) \
...
begin
 { TODO 1 -copenssl inline routines : To replace placeholder body with the actual code. }
  // This is an inline routine or macro. Manual implementation required if needed.
  { Original C Declaration:
    SSL_CTX_set_tlsext_ticket_key_cb(ssl, cb)                 \
...
function ERR_SSL_get_servername(s: PSSL; _type: TIdC_INT): PIdAnsiChar; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_get_servername_procname);
end;

function ERR_SSL_get_servername_type(s: PSSL): TIdC_INT; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_get_servername_type_procname);
end;

function ERR_SSL_export_keying_material(s: PSSL; _out: PIdAnsiChar; olen: TIdC_SIZET; _label: PIdAnsiChar; llen: TIdC_SIZET; context: PIdAnsiChar; contextlen: TIdC_SIZET; use_context: TIdC_INT): TIdC_INT; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_export_keying_material_procname);
end;

function ERR_SSL_export_keying_material_early(s: PSSL; _out: PIdAnsiChar; olen: TIdC_SIZET; _label: PIdAnsiChar; llen: TIdC_SIZET; context: PIdAnsiChar; contextlen: TIdC_SIZET): TIdC_INT; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_export_keying_material_early_procname);
end;

function ERR_SSL_get_peer_signature_type_nid(s: PSSL; pnid: PIdC_INT): TIdC_INT; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_get_peer_signature_type_nid_procname);
end;

function ERR_SSL_get_signature_type_nid(s: PSSL; pnid: PIdC_INT): TIdC_INT; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_get_signature_type_nid_procname);
end;

function ERR_SSL_get_sigalgs(s: PSSL; idx: TIdC_INT; psign: PIdC_INT; phash: PIdC_INT; psignandhash: PIdC_INT; rsig: PIdAnsiChar; rhash: PIdAnsiChar): TIdC_INT; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_get_sigalgs_procname);
end;

function ERR_SSL_get1_builtin_sigalgs(libctx: POSSL_LIB_CTX): PIdAnsiChar; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_get1_builtin_sigalgs_procname);
end;

function ERR_SSL_get_shared_sigalgs(s: PSSL; idx: TIdC_INT; psign: PIdC_INT; phash: PIdC_INT; psignandhash: PIdC_INT; rsig: PIdAnsiChar; rhash: PIdAnsiChar): TIdC_INT; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_get_shared_sigalgs_procname);
end;

function ERR_SSL_check_chain(s: PSSL; x: PX509; pk: PEVP_PKEY; chain: Pstack_st_X509): TIdC_INT; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_check_chain_procname);
end;

function ERR_SSL_CTX_set_tlsext_ticket_key_evp_cb(ctx: PSSL_CTX; fp: TSSL_CTX_set_tlsext_ticket_key_evp_cb_fp_cb): TIdC_INT; cdecl
begin
  ETaurusTLSAPIFunctionNotPresent.RaiseException(SSL_CTX_set_tlsext_ticket_key_evp_cb_procname);
end;
...
begin
  ...
  SSL_get1_builtin_sigalgs := LoadLibFunction(ADllHandle, SSL_get1_builtin_sigalgs_procname);
  FuncLoadError := not assigned(SSL_get1_builtin_sigalgs);
  if FuncLoadError then
  begin
    {$if not defined(SSL_get1_builtin_sigalgs_allownil)}
    SSL_get1_builtin_sigalgs := ERR_SSL_get1_builtin_sigalgs;
    {$ifend}
    {$if declared(SSL_get1_builtin_sigalgs_introduced)}
    if LibVersion < SSL_get1_builtin_sigalgs_introduced then
    begin
      {$if declared(FC_SSL_get1_builtin_sigalgs)}
      SSL_get1_builtin_sigalgs := FC_SSL_get1_builtin_sigalgs;
      {$ifend}
      FuncLoadError := false;
    end;
    {$ifend}
    {$if declared(SSL_get1_builtin_sigalgs_removed)}
    if SSL_get1_builtin_sigalgs_removed <= LibVersion then
    begin
      {$if declared(_SSL_get1_builtin_sigalgs)}
      SSL_get1_builtin_sigalgs := _SSL_get1_builtin_sigalgs;
      {$ifend}
      FuncLoadError := false;
    end;
    {$ifend}
    {$if not defined(SSL_get1_builtin_sigalgs_allownil)}
    if FuncLoadError then
      AFailed.Add('SSL_get1_builtin_sigalgs');
    {$ifend}
  end;
  ...
  SSL_check_chain := LoadLibFunction(ADllHandle, SSL_check_chain_procname);
  FuncLoadError := not assigned(SSL_check_chain);
  if FuncLoadError then
  begin
    {$if not defined(SSL_check_chain_allownil)}
    SSL_check_chain := ERR_SSL_check_chain;
    {$ifend}
    {$if declared(SSL_check_chain_introduced)}
    if LibVersion < SSL_check_chain_introduced then
    begin
      {$if declared(FC_SSL_check_chain)}
      SSL_check_chain := FC_SSL_check_chain;
      {$ifend}
      FuncLoadError := false;
    end;
    {$ifend}
    {$if declared(SSL_check_chain_removed)}
    if SSL_check_chain_removed <= LibVersion then
    begin
      {$if declared(_SSL_check_chain)}
      SSL_check_chain := _SSL_check_chain;
      {$ifend}
      FuncLoadError := false;
    end;
    {$ifend}
    {$if not defined(SSL_check_chain_allownil)}
    if FuncLoadError then
      AFailed.Add('SSL_check_chain');
    {$ifend}
  end;
  
  SSL_CTX_set_tlsext_ticket_key_evp_cb := LoadLibFunction(ADllHandle, SSL_CTX_set_tlsext_ticket_key_evp_cb_procname);
  FuncLoadError := not assigned(SSL_CTX_set_tlsext_ticket_key_evp_cb);
  if FuncLoadError then
  begin
    {$if not defined(SSL_CTX_set_tlsext_ticket_key_evp_cb_allownil)}
    SSL_CTX_set_tlsext_ticket_key_evp_cb := ERR_SSL_CTX_set_tlsext_ticket_key_evp_cb;
    {$ifend}
    {$if declared(SSL_CTX_set_tlsext_ticket_key_evp_cb_introduced)}
    if LibVersion < SSL_CTX_set_tlsext_ticket_key_evp_cb_introduced then
    begin
      {$if declared(FC_SSL_CTX_set_tlsext_ticket_key_evp_cb)}
      SSL_CTX_set_tlsext_ticket_key_evp_cb := FC_SSL_CTX_set_tlsext_ticket_key_evp_cb;
      {$ifend}
      FuncLoadError := false;
    end;
    {$ifend}
    {$if declared(SSL_CTX_set_tlsext_ticket_key_evp_cb_removed)}
    if SSL_CTX_set_tlsext_ticket_key_evp_cb_removed <= LibVersion then
    begin
      {$if declared(_SSL_CTX_set_tlsext_ticket_key_evp_cb)}
      SSL_CTX_set_tlsext_ticket_key_evp_cb := _SSL_CTX_set_tlsext_ticket_key_evp_cb;
      {$ifend}
      FuncLoadError := false;
    end;
    {$ifend}
    {$if not defined(SSL_CTX_set_tlsext_ticket_key_evp_cb_allownil)}
    if FuncLoadError then
      AFailed.Add('SSL_CTX_set_tlsext_ticket_key_evp_cb');
    {$ifend}
  end;
...
begin
  ...
  SSL_get_sigalgs := nil;
  SSL_get1_builtin_sigalgs := nil;
  SSL_get_shared_sigalgs := nil;
  SSL_check_chain := nil;
  SSL_CTX_set_tlsext_ticket_key_evp_cb := nil;
end;
{$ENDIF}
