...
//  function CRYPTO_mem_leaks(BIO: PBIO): TIdC_INT;
  ...
  OPENSSL_gmtime : function(timer : TOSSL_TIMET; Result_ : PIdC_TM) : TIdC_TM; cdecl = nil;
...
//  function CRYPTO_mem_leaks(BIO: PBIO): TIdC_INT;
  ...
  {$EXTERNALSYM OPENSSL_gmtime}
  function OPENSSL_gmtime(timer : TOSSL_TIMET; Result_ : PIdC_TM) : TIdC_TM cdecl; external CLibCrypto;
  {$EXTERNALSYM OPENSSL_gmtime_adj}
...
function ERR_OPENSSL_gmtime(timer : TOSSL_TIMET; Result_ : PIdC_TM) : TIdC_TM; cdecl;
begin
